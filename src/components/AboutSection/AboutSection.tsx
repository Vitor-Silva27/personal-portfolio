    ...
    <section className="py-32 sm:py-64 flex" id="about">
        ...
        <div className='w-full flex flex-col items-center justify-center lg:items-start sm:text-center lg:pl-16 lg:text-left xl:w-3/5'>
            ...
            <div className='w-10/12 2xl:w-4/6'>
                <p className='text-zinc-600 text-base sm:text-xl my-2'>My name is Vitor Silva. I'm a programmer based in Brazil. I've been studying programming since 2020, and I'm passionate about development. I always strive to give my best in any work I do. </p>
