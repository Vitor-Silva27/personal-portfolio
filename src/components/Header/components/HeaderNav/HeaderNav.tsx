...
export const HeaderNav = ({about, contact,projects, lang}: IHeaderNavProps) => {
  ...
  return (
    <div>
        <button className="sm:hidden" onClick={() => setMobileNavOpen()}>
        ...
        <motion.nav 
          ...
          >
            <Link onClick={() => setMobileNavOpen()} className="transition-all hover:-translate-y-1 hover:text-zinc-950" href="#about"><motion.li initial={{ opacity: 0, y: 100 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} >{about}</motion.li></Link>
            <Link onClick={() => setMobileNavOpen()} className="transition-all hover:-translate-y-1 hover:text-zinc-950" href="#projects"><motion.li initial={{ opacity: 0, y: 100 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.25 }}>{projects}</motion.li></Link>
            <Link onClick={() => setMobileNavOpen()} className="transition-all hover:-translate-y-1 hover:text-zinc-950" href="#contact"><motion.li  initial={{ opacity: 0, y: 100 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.5  }}>{contact}</motion.li></Link>
            <LanguageSwitcher currLang={lang} />
            <button className="transition-all hover:-translate-y-1 text-zinc-600  hover:text-zinc-950 flex gap-5 items-center sm:hidden absolute bottom-28" onClick={() => setMobileNavOpen()}>
