...
export const ContactSection = () => {
  ...
  return (
      <section id="contact" className="flex flex-col sm:items-center font-display px-8 relative py-32 sm:py-96 z-10 bg-slate-100 mb-28">
        ...
        <form className="flex flex-col gap-4 mt-10 w-full sm:w-3/4 max-w-xl font-body mb-8"  onSubmit={handleSubmit(onSubmit)}>
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
                <input  {...register('name', { required: true })} type="text" placeholder="Name" className="outline-none bg-transparent border-b-2 border-zinc-950 w-full text-xl focus:border-yellow-400 placeholder:text-zinc-700 py-6" />
                <input  {...register('email', { required: true })} type="email" placeholder="Email" className="outline-none bg-transparent border-b-2 border-zinc-950 w-full text-xl focus:border-yellow-400 placeholder:text-zinc-700  py-6"/>
            </div>
